...
+
Note the variables we're setting at the top of the cell. The *model_url* variable points to the Hugging Face model ID (e.g., `ibm-granite/granite-3.3-2b-instruct:latest`).
+
